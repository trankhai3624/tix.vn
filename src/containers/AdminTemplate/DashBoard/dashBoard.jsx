...
export default function DashBoard() {
  ...
  const userData = useSelector((state) => state.AdminReducer.data);

  const renderComponent = () => {
    if (component === "filmManagement") {
      return <FilmManagement />;
    } else if (component === "showManagement") {
